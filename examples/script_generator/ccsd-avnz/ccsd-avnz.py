...
#       -- created
# 
# Generates SDQ-MP4 and CCSD aug-cc-pVnZ calculations 
#
...
Usage:
    ccsd-avnz.py --name=<name> --ZMAT=<zmat> --runfile=<run.sh> 
    ccsd-avnz.py --joblist 
    ccsd-avnz.py --abrvs
    ccsd-avnz.py (-h | --help)
    ccsd-avnz.py --version
...
def make_joblist(molecule=None, zmat=None, run=None):
    ...
    calcs_list = ['sdqmp4', 'D']
    basis_list = ['aDZ', 'aTZ', 'aQZ', 'a5Z', 'a6Z']
...
if __name__ == '__main__':
    ...
    args = docopt(__doc__, version="ccsd-avnz 1.0")
